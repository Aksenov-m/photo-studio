...
function Brands() {
  return (
    <section id='order' className='order section' name='order'>
        <div className='order__main'>
          ...
          <div className='order__price'>
            <div className='price'>
              ...
              <Link to='brands' rel='noreferrer' className='price__link link' spy={true} smooth={true} offset={-140} duration={900}>
                Перейти →
              </Link>
            </div>
            <div className='price'>
              ...
              <h2 className='price__title'>Услуги</h2>
              <Link to='services' rel='noreferrer' className='price__link link' spy={true} smooth={true} offset={-140} duration={900}>
                Перейти →
              </Link>
            </div>
            <div className='price'>
              ...
              <h2 className='price__title'>Услуги</h2>
              <Link to='info' rel='noreferrer' className='price__link link' spy={true} smooth={true} offset={-70} duration={900}>
                Перейти →
              </Link>
            </div>
          </div>
